    ...
    try {
      ...
      if (!msg) {
        const greetings = [
          ...
          "আমি একটা Robot আমাকে ব্যবহার করতে bot এটা  দিয়ে যা ইচ্ছা বলো bot kamon aso bot ke koro এভাবে 🙄",
          "আমার বাপ SHARAF NAWER SHADHIN আমি তার ২ নাম্বার ছেলে এবং ফাহাদ ১ নাম্বার ভাই আমার ",
          "আমি একটা Robot আমাকে ব্যবহার করতে bot এটা  দিয়ে যা ইচ্ছা বলো bot kamon aso bot ke koro এভাবে"
        ];
